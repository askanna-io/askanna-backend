...
ASKANNA_API_URL = env.str("ASKANNA_API_URL", "https://api.askanna.io")
ASKANNA_CDN_URL = env.str("ASKANNA_CDN_URL", "https://cdn-api.askanna.io")
...
ADMINS = [("""Anna devops""", "devops@askanna.io")]
...
# Disabled the limit
# CELERY_TASK_TIME_LIMIT = 241 * 60 # 241 minutes, replace worker
# http://docs.celeryproject.org/en/latest/userguide/configuration.html#task-soft-time-limit
# TODO: set to whatever value is adequate in your circumstances
# CELERY_TASK_SOFT_TIME_LIMIT = 240 * 60 # max length of 1 job to log
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "askanna_backend.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "askanna_backend.users.adapters.SocialAccountAdapter"
...
ASKANNA_DOCKER_USER = env.str("ASKANNA_DOCKER_USER", None)
ASKANNA_DOCKER_PASS = env.str("ASKANNA_DOCKER_PASS", None)
