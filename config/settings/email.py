...
def settings(config, env):
    ...
    config.DEFAULT_FROM_EMAIL = env("DJANGO_DEFAULT_FROM_EMAIL", default="AskAnna <support@askanna.io>")
    ...
    config.EMAIL_INVITATION_FROM_EMAIL = env("EMAIL_INVITATION_FROM_EMAIL", default=config.DEFAULT_FROM_EMAIL)
