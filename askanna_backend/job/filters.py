...
class RunVariablesDataFilter(django_filters.OrderingFilter):

    custom_ordering = [
        ("variable.name", "Variable name", "variable__name"),
        ("variable.value", "Variable value", "variable__value"),
        ("variable.type", "Variable type", "variable__type"),
    ]
...
class RunVariablesFilter(filters.FilterSet):
    ...
    ordering = RunVariablesDataFilter(fields=(("created", "created"),))
